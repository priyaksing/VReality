...
const HeroSection = () => {
    return (
        <div className='flex flex-col items-center mt-6 lg:mt-20'>
            ...
            <p className='mt-10 text-neutral-500 text-center text-lg max-w-4xl'>
            ...
            <div className='flex my-10 justify-center'>
                <a href="#" className='py-3 px-4 mx-3 bg-gradient-to-r from-orange-500 to-orange-800 rounded-md'>
                    Start for free
                </a>
